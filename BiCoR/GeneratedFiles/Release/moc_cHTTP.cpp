...
QT_MOC_LITERAL(10, 126, 14)
    ...
    "noNetworkAvailable\0sslProblem\0"
    "getFreshDataAfterLogin\0response\0"
    "QNetworkReply*\0fillForm\0showSignupForm\0"
};
...
void CHTTP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->sslProblem(); break;
        case 4: _t->getFreshDataAfterLogin(); break;
        case 5: _t->response((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 6: _t->fillForm((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 7: _t->showSignupForm((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CHTTP::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CHTTP::sslProblem)) {
                *result = 3;
            }
        }
    }
